...
public static class CSHtmlStyleTagParser
{
    public static List<StyleInfo> GetStyleTags(string cshtmlContent)
    {
    ...
    public static List<BaseFinding> ParseStyleTagFindings(List<StyleInfo> styles, Microsoft.CodeAnalysis.TextDocument cshtmlFile)
    {
