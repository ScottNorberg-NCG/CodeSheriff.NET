...
public static class CSHtmlLinkTagParser
{
    public static List<LinkInfo> GetLinkTags(string cshtmlContent)
    {
    ...
    public static List<BaseFinding> ParseLinkTagFindings(List<LinkInfo> links, Microsoft.CodeAnalysis.TextDocument cshtmlFile)
    {
